...
function boxModelAdjustment( elem, dimension, box, isBorderBox, styles, computedVal ) {
	...
	// Root for positive content-box scroll gutter when requested by providing computedVal
...
jQuery.each( [ "height", "width" ], function( i, dimension ) {
	jQuery.cssHooks[ dimension ] = {
		...
		set: function( elem, value, extra ) {
			...
			// Root for unreliable border-box dimensions by comparing offset* to computed and
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		if ( jQuery.css( elem, "position" ) === "fixed" ) {
			...
			// Root for the *real* offset parent, which can be the document or its root element
